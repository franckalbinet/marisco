...
# %% auto 0
__all__ = ['AVOGADRO', 'NC_DIM', 'NC_VARS', 'NC_GROUPS', 'NC_DTYPES', 'CFG_FNAME', 'CDL_FNAME', 'NUCLIDE_LOOKUP_FNAME',
           'MARISCO_CFG_DIRNAME', 'CONFIGS', 'CONFIGS_CDL', 'NETCDF_TO_PYTHON_TYPE', 'base_path', 'cfg', 'nuc_lut_path',
           'lut_path', 'cache_path', 'cdl_cfg', 'species_lut_path', 'bodyparts_lut_path', 'biogroup_lut_path',

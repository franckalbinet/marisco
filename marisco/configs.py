...
# %% auto 0
__all__ = ['BASE_PATH', 'CONFIGS', 'CONFIGS_CDL', 'NETCDF_TO_PYTHON_TYPE', 'name2grp', 'get_nc_tpl_path', 'get_cfgs',
           'get_nuclides_lut']
...
def get_nuclides_lut():
    fname = Path(get_cfgs(key='dirs')['lut']) / 'dbo_nuclide.xlsx'
    return pd.read_excel(fname, index_col='nusymbol', 
                         usecols=['nusymbol', 'nc_name'])['nc_name'].to_dict()

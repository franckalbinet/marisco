...
# %% auto 0
__all__ = ['fname_in', 'fname_out', 'TAXON_KEY_MAP', 'lut_taxon', 'load_to_dataframes', 'ValidateEnumsCB', 'ValidateNetCDFVarsCB',
           'get_taxon_info_lut', 'AddTaxonInformationCB', 'ConvertToHumanReadableCB', 'decode']
...
# %% ../../nbs/handlers/data_format_transformation.ipynb 37
def decode(

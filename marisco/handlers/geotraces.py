"""Data pipeline (handler) to convert [BODC Geotraces dataset](https://www.geotraces.org/geotraces-intermediate-data-product-2021/)"""

# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/handlers/geotraces.ipynb.

# %% auto 0
__all__ = ['fname_in', 'fname_out', 'load_data', 'common_coi', 'nuclides_pattern', 'phase', 'smp_method', 'nuclides_name',
           'units_lut', 'renaming_rules', 'lut_nuclides', 'kw', 'SelectColsOfInterestCB', 'WideToLongCB',
...
# %% ../../nbs/handlers/geotraces.ipynb 21
...
# %% ../../nbs/handlers/geotraces.ipynb 25
...
# %% ../../nbs/handlers/geotraces.ipynb 29
...
# %% ../../nbs/handlers/geotraces.ipynb 33
...
# %% ../../nbs/handlers/geotraces.ipynb 37
...
# %% ../../nbs/handlers/geotraces.ipynb 47
...
class UnshiftLongitudeCB(Callback):
    ...
    def __init__(self, lon_col_name='LON'): fc.store_attr()
    def __call__(self, tfm):

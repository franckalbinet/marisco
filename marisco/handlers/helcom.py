...
# %% auto 0
__all__ = ['src_dir', 'fname_out_nc', 'zotero_key', 'ref_id', 'default_smp_types', 'read_csv', 'fixes_nuclide_names',
           'lut_nuclides', 'coi_sediment', 'coi_val', 'coi_units_unc', 'lut_units', 'lut_dl', 'coi_dl',
           'fixes_biota_species', 'lut_biota', 'fixes_biota_tissues', 'lut_tissues', 'lut_biogroup_from_biota',
           'fixes_sediments', 'lut_sediments', 'sed_replace_lut', 'lut_filtered', 'fixes_lab_names', 'lut_lab',
...
read_csv = lambda o: pd.read_csv(src_dir + '/' + o)
...
def load_data(src_url: str, 
    ...
    def load_and_merge(file_prefix: str) -> pd.DataFrame:
        try:
            df_meas = read_csv(f'{file_prefix}02.csv')
            df_smp = read_csv(f'{file_prefix}01.csv')

...
# %% auto 0
__all__ = ['NC_TPL_PATH', 'varnames_lut_updates', 'coi_units_unc', 'coi_grp', 'renaming_rules', 'kw', 'load_helcom',
           'rename_cols', 'LowerStripRdnNameCB', 'get_unique_nuclides', 'get_varnames_lut', 'RemapRdnNameCB',
           'ParseTimeCB', 'fix_units', 'NormalizeUncUnitCB', 'get_species_lut', 'LookupBiotaSpeciesCB',
           'RenameColumnCB', 'ReshapeLongToWide', 'EncodeTimeCB', 'SanitizeLonLatCB', 'get_attrs', 'units_fn', 'encode']
...
# %% ../../nbs/handlers/helcom_refactored.ipynb 41
...
class LookupBiotaSpeciesCB(Callback):
    ...
    def __init__(self, fn_lut=partial(get_species_lut, fname_in)): 
        fc.store_attr()
...
# %% ../../nbs/handlers/helcom_refactored.ipynb 66
...
# %% ../../nbs/handlers/helcom_refactored.ipynb 69
...
# %% ../../nbs/handlers/helcom_refactored.ipynb 72
...
# %% ../../nbs/handlers/helcom_refactored.ipynb 74

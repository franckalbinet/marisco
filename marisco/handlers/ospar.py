"""Docs: https://franckalbinet.github.io/mariscohandlers/ospar.html.md"""
...
__all__ = ['src_dir', 'fname_out', 'zotero_key', 'default_smp_types', 'nan_cols_to_check', 'fixes_nuclide_names', 'lut_nuclides',
           ...
           'ConvertLonLatCB', 'AddStationCB', 'get_attrs', 'encode']

# %% ../../nbs/handlers/ospar.ipynb #3a8d979f
import pandas as pd 
import numpy as np
...
# %% ../../nbs/handlers/ospar.ipynb #1c47af7c
default_smp_types = {  
    'Biota': 'BIOTA', 
    'Seawater': 'SEAWATER', 
}

# %% ../../nbs/handlers/ospar.ipynb #ee9fb2ee
def read_csv(file_name, dir=src_dir):
    file_path = f'{dir}/{file_name}'
    return pd.read_csv(file_path)

# %% ../../nbs/handlers/ospar.ipynb #a2bf13a1
...
# %% ../../nbs/handlers/ospar.ipynb #9da8fdb8
nan_cols_to_check = ['sampling date', 'activity or mda']

# %% ../../nbs/handlers/ospar.ipynb #35dbbfa1
fixes_nuclide_names = {
    '99tc': 'tc99',
    '238pu': 'pu238',
    '226ra': 'ra226',
...
# %% ../../nbs/handlers/ospar.ipynb #600bce0c
...
# %% ../../nbs/handlers/ospar.ipynb #bcfc8fc1
...
# %% ../../nbs/handlers/ospar.ipynb #ae09bb59
...
# %% ../../nbs/handlers/ospar.ipynb #e448bf2b
...
# %% ../../nbs/handlers/ospar.ipynb #4a721e88
...
# %% ../../nbs/handlers/ospar.ipynb #d430aca5
...
# %% ../../nbs/handlers/ospar.ipynb #d7519752
def get_attrs(
...
# %% ../../nbs/handlers/ospar.ipynb #612c763a
def encode(

# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/api/nc_template-v2.ipynb.

# %% auto 0
__all__ = ['CDL', 'NCTemplate']

# %% ../nbs/api/nc_template-v2.ipynb 2
...
# %% ../nbs/api/nc_template-v2.ipynb 4
CDL = {
    'global_attr': {
...
# %% ../nbs/api/nc_template-v2.ipynb 6
class NCTemplate:
    def __init__(self, 
...
# %% ../nbs/api/nc_template-v2.ipynb 7
@patch
...
# %% ../nbs/api/nc_template-v2.ipynb 8
@patch
...
# %% ../nbs/api/nc_template-v2.ipynb 12
@patch
def generate(self:NCTemplate,
    ...
    with Dataset(fname, 'w', format='NETCDF4') as nc:
        ...
        nc.setncatts(self.cfgs['global_attrs']) 

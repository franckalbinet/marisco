...
# %% auto #0
__all__ = ['NA', 'get_unique_across_dfs', 'Remapper', 'has_valid_varname', 'get_bbox', 'ddmm_to_dd', 'match_worms', 'Match',
           'match_maris_lut', 'test_dfs', 'ExtractNetcdfContents']
...
# %% ../nbs/api/utils.ipynb #6dff2deb
# TBD: move to configs
NA = 'Not available'

# %% ../nbs/api/utils.ipynb #31569370
...
class Remapper():
    ...
    def __init__(self,
                 ...
                 maris_lut_fn: Union[Callable, pd.DataFrame]=None, # Optional: MARIS lookup table or function returning the path; use `maris_lut_key` instead
                 maris_lut_key: str=None, # NC_DTYPES key, e.g. 'NUCLIDE', 'SPECIES', 'BODY_PART'
                 ):
        fc.store_attr()
        self.cache_file = cache_path() / fname_cache
        # Resolve MARIS LUT from key, callable, or direct DataFrame
